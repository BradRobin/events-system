...
// Stores full event objects directly in localStorage
// ============================================
...
function loadWishlist() {
    try {
        ...
        wishlistItems = wishlistItems.filter(item => item && item.id);
...
function removeFromWishlist(eventId) {
    try {
        ...
        localStorage.setItem('event_wishlist', JSON.stringify(wishlistItems));
