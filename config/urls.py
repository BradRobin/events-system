...
from events.api_organizer_views import (
    ...
    api_organizer_events_bulk_delete,
...
urlpatterns = [
    ...
    path('api/organizer/events/bulk-delete/', api_organizer_events_bulk_delete, name='api_organizer_events_bulk_delete'),
    ...
    path('api/attendee/notifications/recent/', attendee_notifications_recent, name='attendee_notifications_recent'),
    path('api/attendee/notifications/unread/', attendee_notifications_unread, name='attendee_notifications_unread'),
    ...
    path('api/organizer/notifications/recent/', organizer_notifications_recent, name='organizer_notifications_recent'),
