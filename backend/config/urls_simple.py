"""
URL Configuration for EventHub Project - SIMPLIFIED FIXED VERSION
"""
...
from admin_views import admin_login_page, admin_login_submit, admin_logout_view as admin_logout
import json
...
urlpatterns = [
    ...
    # Admin Login URLs (using admin_views)
    ...
    path('stories/', TemplateView.as_view(template_name='attendee/pages/stories.html'), name='stories'),
    path('privacy/', TemplateView.as_view(template_name='attendee/pages/privacy.html'), name='privacy'),
    path('terms/', TemplateView.as_view(template_name='attendee/pages/terms.html'), name='terms'),
